...
<head>
    ...
    <!-- Chart core JS -->
    <script src="/taobaoke/Public/Admin/Js/Chart.js"></script>
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a href="<?php echo U('Webinfo/alter_info');?>" type="button" style="margin-top:8px;width:100%;" class="btn btn-success">修 改</a>
                        </div>
                    </div>
                </div>
            </div>
