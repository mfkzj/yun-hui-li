...
<head>
    ...
    <script type="text/javascript">
        ...
        function sendJson(){
            ...
            $.ajax({
                type : "POST",
                url : "<?php echo U('Shoeproduction/catchMessage');?>",
                dataType : "json",
...
<div id="page-wrapper" >
    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
              <li><a href="<?php echo U('Shoeproduction/index');?>">鞋类-单品推介</a></li>
              <li class="active">添加单品推介</li>
            </ol>
        </div>
    </div>
    <form class="form-signin" enctype="multipart/form-data" role="form" action="<?php echo U('Shoeproduction/add_handle');?>" method='post' id="form">
    <!-- 主体 -->
    <div class="row">
        <div class="col-md-12">
