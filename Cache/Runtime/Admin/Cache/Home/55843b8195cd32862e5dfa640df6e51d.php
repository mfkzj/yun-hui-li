        ...
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
           ...
           <ul class="nav nav-sidebar">
            ...
            <li ><a href="<?php echo U('Manclothproduction/index');?>" style="font-size:14px;">－单品推介</a></li>
            ...
            <li ><a href="<?php echo U('Womanclothproduction/index');?>" style="font-size:14px;">－单品推介</a></li>
            ...
            <li ><a href="<?php echo U('Shoeproduction/index');?>" style="font-size:14px;">－单品推介</a></li>
...
<div class="modal fade" id="myModalUrl" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body" style="width:200px;padding:0px;">
        <a id="myModalo"></a>
      </div>
    </div>
  </div>
