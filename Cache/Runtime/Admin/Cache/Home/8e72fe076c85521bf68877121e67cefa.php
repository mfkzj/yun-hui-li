...
<div id="page-wrapper" >
    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
              <li><a href="<?php echo U('Shoeshop/index');?>">鞋类-店铺推荐</a></li>
              <li class="active">修改店铺推荐</li>
            </ol>
        </div>
    </div>
    <form class="form-signin" enctype="multipart/form-data" role="form" action="<?php echo U('Shoeshop/alter_handle');?>" method='post' id="form">
    <!-- 主体 -->
    <div class="row">
        <div class="col-md-12">
