...
<div id="page-wrapper" >
    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
              <li><a href="<?php echo U('Manclothshop/index');?>">男士服装-店铺推荐</a></li>
              <li class="active">修改店铺推荐</li>
            </ol>
        </div>
    </div>
    <form class="form-signin" enctype="multipart/form-data" role="form" action="<?php echo U('Manclothshop/alter_handle');?>" method='post' id="form">
    <!-- 主体 -->
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered">
              <tbody>
                <tr>
                  <td>店铺名称:</td>
                  <td><input name="name" type="text" class="form-control" style="width:320px;" placeholder="请输入姓名" value="<?php echo ($name); ?>"></td>
                </tr>
                <tr>
                  <td>链接地址：</td>
                  <td><input name="url" type="text" class="form-control" style="width:400px;" placeholder="请输入店铺链接地址" value="<?php echo ($url); ?>"></td>
                </tr>
                <tr>
                  <td>当前图片:</td>
                  <td><a href="#" onclick="callmyModal_1('/taobaoke<?php echo ($pic_adr); ?>');"><img src="/taobaoke<?php echo ($pic_adr); ?>" class="img-thumbnail" style="height:200px;width:200px;float:left;"/></a></td>
                </tr>
                <tr>
                  <td>上传新的图片:</td>
