...
<head>
    ...
    <script type="text/javascript">
        ...
        function callmyModalText(id){
            $.getJSON("<?php echo U('Manclothshop/get_url');?>?id="+id, function (data, status, xhr) {
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-12" style="margin-bottom:10px;">
                    ...
                    <div style="float:right;"><a href="<?php echo U('Manclothshop/add');?>" style="width:150px;"type="button" class="btn btn-primary">新增店铺推荐</a></div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                    ...
                                    <td>
                                        <div align="center">
                                            <div style="width:200px;padding-top:6px;">
                                                <?php if($key == 0): ?><a href="<?php echo U('Manclothshop/sort_handle');?>?id=<?php echo ($data["id"]); ?>&type=down"class="btn btn-default"><i class="icon-angle-down"></i></a>
                                                <?php elseif($key == count($shop)-1): ?>
                                                    <a href="<?php echo U('Manclothshop/sort_handle');?>?id=<?php echo ($data["id"]); ?>&type=up"class="btn btn-default"><i class="icon-angle-up"></i></a>
                                                <?php else: ?>
                                                    <a href="<?php echo U('Manclothshop/sort_handle');?>?id=<?php echo ($data["id"]); ?>&type=up"class="btn btn-default"><i class="icon-angle-up"></i></a>
                                                    <a href="<?php echo U('Manclothshop/sort_handle');?>?id=<?php echo ($data["id"]); ?>&type=down"class="btn btn-default"><i class="icon-angle-down"></i></a><?php endif; ?>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div align="center">
                                            <div style="width:200px;padding-top:6px;">
                                                <a type="button" class="btn btn-success" href="<?php echo U('Manclothshop/alter');?>?id=<?php echo ($data["id"]); ?>">修 改</a>
                                                <a type="button" class="btn btn-danger" href="<?php echo U('Manclothshop/delete_handle');?>?id=<?php echo ($data["id"]); ?>">删 除</a>
                                            </div>
                                        </div>
                                    </td>
