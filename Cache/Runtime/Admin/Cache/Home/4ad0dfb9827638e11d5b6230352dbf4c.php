...
<div id="page-wrapper" >
    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
              <li><a href="<?php echo U('Womancloth/index');?>">女士服装模块</a></li>
              <li class="active">修改分类</li>
            </ol>
        </div>
    </div>
    <form class="form-signin" enctype="multipart/form-data" role="form" action="<?php echo U('Womancloth/alter_classification_handle');?>" method='post' id="form">
    <!-- 主体 -->
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered">
              <tbody>
                <tr>
                  <td>名称:</td>
                  <td><input name="name" type="text" class="form-control" style="width:320px;" value="<?php echo ($name); ?>" placeholder="请输入姓名"></td>
                </tr>
              </tbody>
            </table>
