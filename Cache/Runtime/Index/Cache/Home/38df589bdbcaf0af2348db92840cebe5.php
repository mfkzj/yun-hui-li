        ...
        <div class="row">
          ...
          <div class="col-md-10">
            <div class="row">
              ...
              <a href="<?php echo U('Production/mancloth');?>"><div class="col-md-1 active">单品推介</div></a>
              <a href="<?php echo U('Shop/mancloth');?>"><div class="col-md-1 choice">店铺推荐</div></a>
                ...
                <div class="col-md-1">
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                      <?php if(is_array($classification)): foreach($classification as $key=>$data): ?><li><a href="<?php echo U('Production/mancloth');?>?classify=<?php echo ($data["id"]); ?>"><?php echo ($data["name"]); ?></a></li><?php endforeach; endif; ?>
                      <li role="separator" class="divider"></li>
                      <li><a href="<?php echo U('Production/mancloth');?>?classify=all">全部</a></li>
                    </ul>
                  </div>
                </div>
                <div class="col-md-1" style="padding:0px">
                  <a href="<?php echo U('Production/mancloth');?>">男士服装</a>
                </div>
                <div class="col-md-1" style="padding:0px">
                  <a href="<?php echo U('Production/womancloth');?>">女士服装</a>
                </div>
                <div class="col-md-1">
                  <a href="<?php echo U('Production/shoe');?>">鞋</a>
                </div>
              </div>
              <div class="col-md-1">
              </div>
