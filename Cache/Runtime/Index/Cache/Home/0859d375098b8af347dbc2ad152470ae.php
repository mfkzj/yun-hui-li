        ...
        <div class="row">
          ...
          <div class="col-md-10">
            <div class="row">
              ...
              <a href="<?php echo U('Production/Shoe');?>"><div class="col-md-1 active">单品推介</div></a>
              <a href="<?php echo U('Shop/Shoe');?>"><div class="col-md-1 choice">店铺推荐</div></a>
                ...
                <div class="col-md-1">
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                      <?php if(is_array($classification)): foreach($classification as $key=>$data): ?><li><a href="<?php echo U('Production/Shoe');?>?classify=<?php echo ($data["id"]); ?>"><?php echo ($data["name"]); ?></a></li><?php endforeach; endif; ?>
                      <li role="separator" class="divider"></li>
                      <li><a href="<?php echo U('Production/Shoe');?>?classify=all">全部</a></li>
                    </ul>
                  </div>
                </div>
