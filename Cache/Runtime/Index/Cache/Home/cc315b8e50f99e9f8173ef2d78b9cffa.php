        ...
        <div class="row">
          ...
          <div class="col-md-10">
            <div class="row">
              ...
              <a href="<?php echo U('Production/Womancloth');?>"><div class="col-md-1 choice">单品推介</div></a>
              <a href="<?php echo U('Shop/Womancloth');?>"><div class="col-md-1 active">店铺推荐</div></a>
                ...
                <?php if(is_array($production)): foreach($production as $key=>$data): ?><div class="col-md-4">
                  <a class="ef" href="<?php echo ($data["url"]); ?>">
                    <div class="J_super_item item-mod  super-item-start">
                      <img style="display: block;" class="img lazy" alt="<?php echo ($data["name"]); ?>" src="/taobaoke<?php echo ($data["pic_adr"]); ?>">
